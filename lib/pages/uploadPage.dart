...
class _UploadState extends State<Upload> {
  ...
  String rating = '5';
  var items =  ['Action','Drama','Comedy','Horror','Thriller','SciFi','Romantic','Romantic Comedy','Time Period Drama','Adventure','Fantasy','Animation','Foriegn'];
  var type = ['Movie','Series','Music']; 
